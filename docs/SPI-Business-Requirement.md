...
Angle 	Investor(A): Assess each startup performance Investor (Monitor KPI Reports) 
...
StartupTeam(A) 	--> SPI 	Application 		--> Feed Information (schedule) 

Admin (A) 		--> SPI Application 			--> Feed Metadata, Review/Approve 

Data & Metadat 	--> Data 	Analytics 		--> Aggregated KPI 

Angle Investor (A) 	--> SPI 	Application 		--> Dashboard(KPI,Portfolio, Index) 

Data & Metadat 	--> DA 	(Monitoring, Alert) 	--> Angle Investor (A), StartupTeam(A) 

Angle Investor (A) 	--> AI 	(Information + Prompt) 	--> Answer (Response) 
